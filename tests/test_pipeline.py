...
# Contenido militar puro = ruido para aeropuerto civil (bug demo: F-15E Strike Eagles en top)
ok("relevante · F-15E militar NO entra", not REL.is_relevant("The US Air Force Is Scrapping 119 F-15E Strike Eagles"))
ok("relevante · F/A-18 tanker militar NO entra", not REL.is_relevant("Autonomous Tanker frees the F/A-18 Super Hornet"))
ok("relevante · militar CON ancla civil (Punta Cana) SÍ", REL.is_relevant("Air Force One diverted to Punta Cana airport"))
